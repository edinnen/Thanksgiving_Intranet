...
# System config
use constant ADMIN_PASS => 'alarm';	# Admin password. For fucks's sake, change this.
use constant SECRET => 'Yh3eoXNw5ARvK73WDU5OZEUwXNLJFoShj9i7WhwVN7trpsg7Za6rVscENbgF2wvaLLvhOq9A6F0EcFrjbJiQl0DDYIflQ0fYoCeFrZyY32LRzDHKGowgSACgX1IDOkrV';		# Cryptographic secret. CHANGE THIS to something totally random, and long.
