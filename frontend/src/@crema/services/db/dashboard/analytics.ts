export default {
  ...
  revenueCards: [
    {
      ...
      value: '$3,732',
      growth: 2.5,
      icon: require('assets/images/dashboard/icon_revenue.png'),
      strokeColor: '#f44d50',
      graphData: [
    ...
    },
    {
      ...
      value: '882',
      growth: 3.7,
      icon: require('assets/images/dashboard/icon_visits.png'),
      strokeColor: '#f49820',
      graphData: [
        {month: 'Jan', number: 20},
  ...
  salesState: [
    {
      ...
      amount: '3510',
      type: 'Author Sales',
      icon: require('assets/images/dashboard/auther_sales.png'),
    },
    {
      id: 2,
      amount: '390',
      type: 'Commissions',
      icon: require('assets/images/dashboard/commission_sale.png'),
    },
    {
      id: 3,
      amount: '3.2M',
      type: 'All Time Revenue',
      icon: require('assets/images/dashboard/all_time_sales.png'),
    },
  ],
  salesChartData: [
    {title: 'Author Sales', value: 100, color: '#0A8FDC'},
  ...
  topSellingProduct: [
    {
      id: 1,
      icon: require('assets/images/dashboard/product_image_1.png'),
      name: 'Antler Theme',
    ...
    {
      id: 1,
      icon: require('assets/images/dashboard/product_image_2.png'),
    ...
    {
      id: 1,
      icon: require('assets/images/dashboard/product_image_3.png'),
      name: 'Puzzle Mask',
  ...
  infoWidgets: [
    {
      id: 1,
      icon: require('assets/images/dashboard/icon_phone.png'),
      count: 5623,
    ...
    {
      id: 2,
      icon: require('assets/images/dashboard/icon_desktop.png'),
      count: 7632,
    ...
    {
      id: 3,
      icon: require('assets/images/dashboard/icon_android.png'),
      count: 1234,
