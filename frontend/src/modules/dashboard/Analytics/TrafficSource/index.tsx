...
import {TrafficData} from '../../../../types/models/Analytics';
...
const AccordionSummary = withStyles((theme) => ({
  root: (props: AccordionSummaryProps) => ({
        ...
        <Accordion
          ...
          <AccordionDetails>
            <Box display='flex' flex={1} justifyContent='flex-end'>
              <Box component='span' ml={2} fontFamily={Fonts.LIGHT}>
                {data.session}
              </Box>
              <Box ml={2} component='span' color='text.hint'>
                Session
              </Box>
            </Box>
          </AccordionDetails>
