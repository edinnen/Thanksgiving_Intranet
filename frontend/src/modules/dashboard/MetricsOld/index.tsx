          ...
          <GridContainer>
            <Grid item xs={12} sm={6} md={3}>
              <StatsCard
                ...
                bgColor={red[500]}
                icon={require('assets/images/metricsIcons/order.png')}
              />
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <StatsCard
                ...
                bgColor={blue[300]}
                icon={require('assets/images/metricsIcons/revenue.png')}
              />
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <StatsCard
                ...
                bgColor={indigo[400]}
                icon={require('assets/images/metricsIcons/visits.png')}
              />
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <StatsCard
                ...
                bgColor={green[500]}
                icon={require('assets/images/metricsIcons/querries.png')}
              />
            </Grid>
