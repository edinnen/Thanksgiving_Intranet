...
bool GPS_SLEEP_FLAG = 1; // Is the GPS asleep? default is yes.
const unsigned int GPS_SYNC_INTERVAL = 30; // Seconds between GPS time readings
const unsigned int RTC_SYNC_INTERVAL = 10; // Seconds between RTC time readings
