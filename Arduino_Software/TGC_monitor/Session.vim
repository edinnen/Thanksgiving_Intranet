...
set ruler
set runtimepath=~/.vim,~/.vim/pack/vim-javascript/start/vim-javascript,~/.vim/bundle/lh-tags,~/.vim/bundle/lh-vim-lib,~/.vim/bundle/nerdtree,~/.vim/bundle/tagbar,~/.vim/bundle/vim-autoformat,~/.vim/bundle/vim-go,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/bundle/lh-vim-lib/after,~/.vim/after,~/.vim/pack/vim-javascript/start/vim-javascript/after
set shiftwidth=4
set showcmd
set showmatch
set smartcase
...
silent only
cd ~/Documents/Arduino/Thanksgiving_Intranet/Arduino_Software/TGC_monitor
